import { ClientSideRowModelModule, ClipboardModule, RangeSelectionModule, RichSelectModule, RowGroupingModule, MenuModule, MultiFilterModule, SetFilterModule, AllModules } from '@ag-grid-enterprise/all-modules';
...
import { Column, Module } from '@ag-grid-community/all-modules';
...
export class SimpleAgGridComponent extends AppComponentBase implements OnInit {
  ...
  @Output() onRowGroupOpened = new EventEmitter();
  ...
  onGroupOpened(params: any){
    return this.onRowGroupOpened.emit(params)
  }
